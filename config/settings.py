...
YOLO_MODEL                 = "yolov8m.pt"
GADGET_CLASSES             = ["cell phone"]
GADGET_CONFIDENCE_THRESHOLD = 0.40
PILOT_CONFIDENCE_THRESHOLD  = 0.40
MAX_PILOTS                 = 2
...
GADGET_MAX_ASPECT          = 1.20   # rejects walkie-talkie (aspect ~1.1–1.35)
GADGET_MAX_WIDTH_FRACTION  = 0.30
GADGET_MIN_WIDTH_PX        = 15
GADGET_MIN_HEIGHT_PX       = 20

# ── Edge variance filter (Filter D) ──────────────────────────────────────────
GADGET_MIN_EDGE_VARIANCE   = 40.0   # floored at 35.0 in code for IR footage
