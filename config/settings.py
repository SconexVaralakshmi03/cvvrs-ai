...
GADGET_CONFIDENCE_THRESHOLD = 0.35 
PILOT_CONFIDENCE_THRESHOLD = 0.65 
MAX_PILOTS = 2 
...
DISPLAY_SCALE = 1.0 
GADGET_MIN_AREA = 250
GADGET_MIN_ASPECT = 0.52
GADGET_MAX_ASPECT = 2.8
GADGET_MAX_WIDTH_FRACTION = 0.40
GADGET_MIN_WIDTH_PX = 15
GADGET_MIN_HEIGHT_PX = 15
GADGET_MIN_EDGE_VARIANCE = 6.0
